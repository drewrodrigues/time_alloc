# TODO: implement a storage system / markup language to save and parse
# data
# TODO: events -> add whether they are generated or manually created
# so that it's easier to re-generate a schedule or strip non-manual
# entries
...
# TODO: try creating method callbacks with procs ? like automatic ones
# like Rails after_action
...
# TODO: raise errors on incorrect usage of methods, return false when
# used correctly but failed
# TODO: change Calendar to Schedule (calendar will hold [Day], and Day
# will hold [Schedule]
